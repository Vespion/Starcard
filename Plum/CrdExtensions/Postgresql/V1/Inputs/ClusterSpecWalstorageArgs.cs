...
namespace Pulumi.Kubernetes.Types.Inputs.Postgresql.V1
{
    ...
    /// </summary>
    public class ClusterSpecWalstorageArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Template to be used to generate the Persistent Volume Claim
        /// </summary>
        [Input("pvcTemplate")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Postgresql.V1.ClusterSpecWalstoragePvctemplateArgs>? PvcTemplate { get; set; }
        ...
        public ClusterSpecWalstorageArgs()
        {
            ResizeInUseVolumes = true;
        }
        public static new ClusterSpecWalstorageArgs Empty => new ClusterSpecWalstorageArgs();
    }
}
