...
namespace Pulumi.Kubernetes.Types.Inputs.Postgresql.V1
{
    ...
    /// </summary>
    public class ClusterSpecBackupBarmanobjectstoreArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// The credentials to use to upload data to Azure Blob Storage
        /// </summary>
        [Input("azureCredentials")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Postgresql.V1.ClusterSpecBackupBarmanobjectstoreAzurecredentialsArgs>? AzureCredentials { get; set; }
        ...
        /// </summary>
        [Input("data")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Postgresql.V1.ClusterSpecBackupBarmanobjectstoreDataArgs>? Data { get; set; }
        ...
        /// </summary>
        [Input("endpointCA")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Postgresql.V1.ClusterSpecBackupBarmanobjectstoreEndpointcaArgs>? EndpointCA { get; set; }
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Postgresql.V1.ClusterSpecBackupBarmanobjectstoreGooglecredentialsArgs>? GoogleCredentials { get; set; }
        ...
        /// </summary>
        [Input("s3Credentials")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Postgresql.V1.ClusterSpecBackupBarmanobjectstoreS3credentialsArgs>? S3Credentials { get; set; }
        ...
        /// </summary>
        [Input("wal")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Postgresql.V1.ClusterSpecBackupBarmanobjectstoreWalArgs>? Wal { get; set; }

        public ClusterSpecBackupBarmanobjectstoreArgs()
        {
        }
        public static new ClusterSpecBackupBarmanobjectstoreArgs Empty => new ClusterSpecBackupBarmanobjectstoreArgs();
    }
}
