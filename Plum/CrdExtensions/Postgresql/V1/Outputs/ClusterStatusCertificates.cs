...
namespace Pulumi.Kubernetes.Types.Outputs.Postgresql.V1
{
    ...
    /// </summary>
    [OutputType]
    public sealed class ClusterStatusCertificates
    {
        /// <summary>
        ...
        /// </summary>
        public readonly ImmutableDictionary<string, string> Expirations;
        /// <summary>
        ...
        [OutputConstructor]
        private ClusterStatusCertificates(
            string clientCASecret,

            ImmutableDictionary<string, string> expirations,
