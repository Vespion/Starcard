...
namespace Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2
{
    ...
    /// </summary>
    public class ClusterOutputSpecForwardTlsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("keyPassword")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2.ClusterOutputSpecForwardTlsKeypasswordArgs>? KeyPassword { get; set; }
        ...
        public ClusterOutputSpecForwardTlsArgs()
        {
        }
        public static new ClusterOutputSpecForwardTlsArgs Empty => new ClusterOutputSpecForwardTlsArgs();
    }
}
