...
namespace Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2
{
    ...
    /// </summary>
    public class ClusterOutputSpecTcpTlsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("keyPassword")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2.ClusterOutputSpecTcpTlsKeypasswordArgs>? KeyPassword { get; set; }
        ...
        public ClusterOutputSpecTcpTlsArgs()
        {
        }
        public static new ClusterOutputSpecTcpTlsArgs Empty => new ClusterOutputSpecTcpTlsArgs();
    }
}
