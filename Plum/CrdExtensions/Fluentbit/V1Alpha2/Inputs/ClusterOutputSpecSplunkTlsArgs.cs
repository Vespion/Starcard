...
namespace Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2
{
    ...
    /// </summary>
    public class ClusterOutputSpecSplunkTlsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("keyPassword")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2.ClusterOutputSpecSplunkTlsKeypasswordArgs>? KeyPassword { get; set; }
        ...
        public ClusterOutputSpecSplunkTlsArgs()
        {
        }
        public static new ClusterOutputSpecSplunkTlsArgs Empty => new ClusterOutputSpecSplunkTlsArgs();
    }
}
