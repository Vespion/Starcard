...
namespace Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2
{
    ...
    /// </summary>
    public class ClusterOutputSpecHttpTlsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("keyPassword")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2.ClusterOutputSpecHttpTlsKeypasswordArgs>? KeyPassword { get; set; }
        ...
        public ClusterOutputSpecHttpTlsArgs()
        {
        }
        public static new ClusterOutputSpecHttpTlsArgs Empty => new ClusterOutputSpecHttpTlsArgs();
    }
}
