...
namespace Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2
{
    ...
    /// </summary>
    public class ClusterOutputSpecOpensearchTlsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("keyPassword")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2.ClusterOutputSpecOpensearchTlsKeypasswordArgs>? KeyPassword { get; set; }
        ...
        public ClusterOutputSpecOpensearchTlsArgs()
        {
        }
        public static new ClusterOutputSpecOpensearchTlsArgs Empty => new ClusterOutputSpecOpensearchTlsArgs();
    }
}
