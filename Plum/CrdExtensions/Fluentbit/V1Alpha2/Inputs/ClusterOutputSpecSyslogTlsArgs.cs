...
namespace Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2
{
    ...
    /// </summary>
    public class ClusterOutputSpecSyslogTlsArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        ...
        /// </summary>
        [Input("keyPassword")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Fluentbit.V1Alpha2.ClusterOutputSpecSyslogTlsKeypasswordArgs>? KeyPassword { get; set; }
        ...
        public ClusterOutputSpecSyslogTlsArgs()
        {
        }
        public static new ClusterOutputSpecSyslogTlsArgs Empty => new ClusterOutputSpecSyslogTlsArgs();
    }
}
