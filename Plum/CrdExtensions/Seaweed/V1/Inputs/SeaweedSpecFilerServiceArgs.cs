...
namespace Pulumi.Kubernetes.Types.Inputs.Seaweed.V1
{
    ...
    /// </summary>
    public class SeaweedSpecFilerServiceArgs : global::Pulumi.ResourceArgs
    {
        [Input("annotations")]
        ...
        public SeaweedSpecFilerServiceArgs()
        {
        }
        public static new SeaweedSpecFilerServiceArgs Empty => new SeaweedSpecFilerServiceArgs();
    }
}
