...
namespace Pulumi.Kubernetes.Types.Inputs.Seaweed.V1
{
    ...
    /// Filer
    /// </summary>
    public class SeaweedSpecFilerArgs : global::Pulumi.ResourceArgs
    {
        /// <summary>
        /// Affinity of the component. Override the cluster-level one if present
        /// </summary>
        [Input("affinity")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerAffinityArgs>? Affinity { get; set; }
        ...
        [Input("env")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerEnvArgs>? _env;
        ...
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerEnvArgs> Env
        {
            get => _env ?? (_env = new InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerEnvArgs>());
            set => _env = value;
        }
        ...
        private InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerImagepullsecretsArgs>? _imagePullSecrets;

        /// <summary>
        /// ImagePullSecrets is an optional list of references to secrets in the same namespace to use for pulling any of the images.
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerImagepullsecretsArgs> ImagePullSecrets
        {
            get => _imagePullSecrets ?? (_imagePullSecrets = new InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerImagepullsecretsArgs>());
        ...
        [Input("maxMB")]
        public Input<int>? MaxMB { get; set; }
        ...
        /// </summary>
        [Input("service")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerServiceArgs>? Service { get; set; }
        ...
        [Input("tolerations")]
        private InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerTolerationsArgs>? _tolerations;

        /// <summary>
        /// Tolerations of the component. Override the cluster-level tolerations if non-empty
        /// </summary>
        public InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerTolerationsArgs> Tolerations
        {
            get => _tolerations ?? (_tolerations = new InputList<Pulumi.Kubernetes.Types.Inputs.Seaweed.V1.SeaweedSpecFilerTolerationsArgs>());
        ...
        public SeaweedSpecFilerArgs()
        {
            S3 = true;
        }
        public static new SeaweedSpecFilerArgs Empty => new SeaweedSpecFilerArgs();
    }
}
