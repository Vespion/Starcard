...
namespace Pulumi.Kubernetes.Types.Outputs.Vault.V1Alpha1
{
    ...
    [OutputType]
    public sealed class VaultSpecVaultconfigurerpodspecEphemeralcontainersVolumemounts
    {
        ...
        [OutputConstructor]
        private VaultSpecVaultconfigurerpodspecEphemeralcontainersVolumemounts(
            string mountPath,
