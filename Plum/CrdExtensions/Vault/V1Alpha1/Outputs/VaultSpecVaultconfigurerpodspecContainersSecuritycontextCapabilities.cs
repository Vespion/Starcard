...
namespace Pulumi.Kubernetes.Types.Outputs.Vault.V1Alpha1
{
    ...
    [OutputType]
    public sealed class VaultSpecVaultconfigurerpodspecContainersSecuritycontextCapabilities
    {
        public readonly ImmutableArray<string> Add;
        public readonly ImmutableArray<string> Drop;

        [OutputConstructor]
        private VaultSpecVaultconfigurerpodspecContainersSecuritycontextCapabilities(
