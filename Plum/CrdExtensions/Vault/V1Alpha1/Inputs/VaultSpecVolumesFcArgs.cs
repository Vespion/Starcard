...
namespace Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1
{
    ...
    public class VaultSpecVolumesFcArgs : global::Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public VaultSpecVolumesFcArgs()
        {
        }
        public static new VaultSpecVolumesFcArgs Empty => new VaultSpecVolumesFcArgs();
    }
}
