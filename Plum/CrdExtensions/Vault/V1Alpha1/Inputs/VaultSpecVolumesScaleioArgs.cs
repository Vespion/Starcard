...
namespace Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1
{
    ...
    public class VaultSpecVolumesScaleioArgs : global::Pulumi.ResourceArgs
    {
        [Input("fsType")]
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1.VaultSpecVolumesScaleioSecretrefArgs> SecretRef { get; set; } = null!;
        ...
        public VaultSpecVolumesScaleioArgs()
        {
        }
        public static new VaultSpecVolumesScaleioArgs Empty => new VaultSpecVolumesScaleioArgs();
    }
}
