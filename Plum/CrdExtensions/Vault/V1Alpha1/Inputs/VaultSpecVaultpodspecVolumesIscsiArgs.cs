...
namespace Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1
{
    ...
    public class VaultSpecVaultpodspecVolumesIscsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1.VaultSpecVaultpodspecVolumesIscsiSecretrefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public VaultSpecVaultpodspecVolumesIscsiArgs()
        {
        }
        public static new VaultSpecVaultpodspecVolumesIscsiArgs Empty => new VaultSpecVaultpodspecVolumesIscsiArgs();
    }
}
