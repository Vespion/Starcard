...
namespace Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1
{
    ...
    public class VaultSpecVolumesCsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        public Input<Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1.VaultSpecVolumesCsiNodepublishsecretrefArgs>? NodePublishSecretRef { get; set; }
        ...
        public VaultSpecVolumesCsiArgs()
        {
        }
        public static new VaultSpecVolumesCsiArgs Empty => new VaultSpecVolumesCsiArgs();
    }
}
