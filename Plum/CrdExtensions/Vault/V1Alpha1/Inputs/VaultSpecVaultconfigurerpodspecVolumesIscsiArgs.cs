...
namespace Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1
{
    ...
    public class VaultSpecVaultconfigurerpodspecVolumesIscsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1.VaultSpecVaultconfigurerpodspecVolumesIscsiSecretrefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public VaultSpecVaultconfigurerpodspecVolumesIscsiArgs()
        {
        }
        public static new VaultSpecVaultconfigurerpodspecVolumesIscsiArgs Empty => new VaultSpecVaultconfigurerpodspecVolumesIscsiArgs();
    }
}
