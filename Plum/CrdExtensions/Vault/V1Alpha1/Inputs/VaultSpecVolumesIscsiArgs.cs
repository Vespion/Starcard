...
namespace Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1
{
    ...
    public class VaultSpecVolumesIscsiArgs : global::Pulumi.ResourceArgs
    {
        ...
        [Input("secretRef")]
        public Input<Pulumi.Kubernetes.Types.Inputs.Vault.V1Alpha1.VaultSpecVolumesIscsiSecretrefArgs>? SecretRef { get; set; }

        [Input("targetPortal", required: true)]
        public Input<string> TargetPortal { get; set; } = null!;

        public VaultSpecVolumesIscsiArgs()
        {
        }
        public static new VaultSpecVolumesIscsiArgs Empty => new VaultSpecVolumesIscsiArgs();
    }
}
